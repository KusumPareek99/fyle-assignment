...
//       this.submit();
//       fetch('https://getform.io/your-endpoint', { method: 'POST', body: new FormData(this) });
//     }
//   });
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Other functionalities (slider, read more button, our project section, experts growth)...
});
...
//   function updateSlider() {
//     const sliderWrapper = document.querySelector('.slider-wrapper');
//     sliderWrapper.style.transform = `translateX(-${currentIndex * (370 + 30)}px)`;
//     dots.forEach(dot => dot.classList.remove('active'));
//     dots[currentIndex].classList.add('active');
//   }
...
// 'Read more' button to open in a new tab
//   document.querySelectorAll('.read_more_btn').forEach(btn => {
//     btn.addEventListener('click', function (e) {
//       window.open(this.href, '_blank');
//     });
